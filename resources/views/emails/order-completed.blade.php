...
<head>
    ...
    <title>Pesanan Selesai - MarketKu</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
                    <tr>
                        <td style="padding:40px 40px 24px;text-align:center;">
                            ...
                            <h1 style="margin:16px 0 8px;font-size:24px;font-weight:900;color:#0f172a;">Pesanan Selesai</h1>
                            <p style="margin:0;font-size:14px;color:#64748b;line-height:1.6;">Hai {{ $buyerName }}, pesanan kamu telah selesai dikerjakan. Terima kasih sudah berbelanja di MarketKu.</p>
                        </td>
                    </tr>
                    <tr>
