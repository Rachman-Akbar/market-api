...
class GetShippingOptionsUseCase
{
    ...
    private function storeContext(int $storeId, string $storeName, object $destination): array
    {
        $originAddress = DB::table('addresses')
        ...
        $originLatitude = $setting->store_latitude ?? $originAddress->latitude ?? null;
        $originLongitude = $setting->store_longitude ?? $originAddress->longitude ?? null;
