...
final class OrderProcessingMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "Pesanan #{$this->order->orderNumber} Sedang Diproses",
        );
    }
    ...
    {
        return new Content(
            htmlView: 'emails.order-processing',
            with: [
