...
final class Product
{
    ...
    public function store(): ?Store { return $this->store; }
    ...
    public function changePrice(float $price): void { $this->price = $price; }
    public function changeStock(int $stock): void { $this->stock = $stock; }
    ...
    public function assignCategory(?int $categoryId): void { $this->categoryId = $categoryId; }
}